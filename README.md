    ...
    Callback = function(selectedPlayer)
        if selectedPlayer then
            ...
            if targetPlayer and player.Character then
                -- Etapa 1: Força o jogador selecionado a carregar quem usa o script
                local ohInstance1 = game:GetService("Players"):FindFirstChild(selectedPlayer) -- Acessa o jogador pelo nome
