...
local updatesSection = updatesTab:CreateSection("Updates", false)
local farmSection = farmTab:CreateSection("Key farm functions", false)
local pvpSection = pvpTab:CreateSection("Main functions of pvp", false)
local skinsSection = skinsTab:CreateSection("Unlock skins with one click", false)
local teleportsSection = teleportsTab:CreateSection("Teleport locations for easy locomotion", false)

local miscTab = Window:CreateTab("Misc", 4483362458)
local miscSection = miscTab:CreateSection("Other extra functions", false)
...
local scriptsSection = scriptsTab:CreateSection("Recommended Scripts", false)
...
teleportsSection:CreateParagraph({
...
updatesSection:CreateParagraph({
    Title = "Version 1.0.0",
...
updatesSection:CreateSeparator({
